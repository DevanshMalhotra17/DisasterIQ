...
# Synthetic climate input generator

def generate_random_climate(rng: np.random.Generator, severity: str = "any") -> dict:
    """
    severity: 'low' | 'high' | 'any'
    Oversampling disaster scenarios ensures balanced training classes.
    """
    if severity == "high":
...
# Dataset generation — 50/50 normal vs disaster scenarios
